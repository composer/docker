...
test:
	docker run -t composer:latest --no-ansi | grep 'Composer version 1.6.4'
	docker run -t composer:1 --no-ansi | grep 'Composer version 1.6.4'
	docker run -t composer:1.6 --no-ansi | grep 'Composer version 1.6.4'
